                    ...
                    <ol role="list" class="flex space-x-0">
                        <li class="flex">
                            <div class="flex items-center">
                                <Link :href="route('admin.dashboard')" :class="{ 'text-sky-500': $page.url === route('admin.dashboard') }"
                        ...
                        <li v-show="(crumbsLength >= 1)"
                            ...
                            <div v-if="!(crumbsLength-1 == key)" class="flex items-center">
                                <svg class="flex-shrink-0 w-6 h-full text-gray-100 dark:text-gray-700" viewBox="0 0 24 44"
