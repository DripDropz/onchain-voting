    ...
    <div class="w-full bg-sky-100 border border-slate-200 dark:bg-gray-900 rounded-xl dark:border-gray-700">
                    ...
                    <Menu as="div" class="relative ml-auto">
                        ...
                        <transition enter-active-class="transition duration-100 ease-out"
                            ...
                            <MenuItems
                                ...
                                <MenuItem v-slot="{ active }">
                                <a @click=" isBallotPublished ? '' : confirmUserDeletion()"
                    ...
                    <Modal :show="confirmingUserDeletion" @close="closeModal">
                        <div class="p-6">
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Once the question is deleted, all of its resources and data will be permanently deleted.

                            </p>
                            <div class="flex justify-end mt-6">
                                <SecondaryButton @click="closeModal"> Cancel </SecondaryButton>

                                <DangerButton class="ml-3 text" :class="{ 'opacity-25': form.processing }"
                                    :disabled="form.processing" @click="deleteQuestion">
                                    Delete Question
                                </DangerButton>
                            </div>
                        </div>
        ...
        <div class="px-3 sm:p-4 rounded-b-xl">
            ...
            <div class="flex flex-col gap-1 mt-4">
                <div>
                    <QuestionChoiceList :ballot="ballot" :question="question" :choices="question.choices"
...
let isBallotPublished = (props.ballot.status == 'published') ? true : false;
