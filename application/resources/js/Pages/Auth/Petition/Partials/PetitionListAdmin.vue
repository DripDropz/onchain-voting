<template>
  <div class="flex">
    <div>
      <div class="flex flex-row items-center justify-between border border-t-0 border-l-0 border-r-0 border-b-1">
        <div>
      ...
      <div v-for="petition in petitions" :key="petition.hash"
        class="flex flex-row my-8 border rounded-lg border-slate-900 dark:border-slate-700 dark:text-slate-100">
        <div class="w-2/3">
          <div class="p-4">
