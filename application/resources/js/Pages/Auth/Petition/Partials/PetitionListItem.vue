      ...
      <div
        ...
        <div class="flex flex-row items-center gap-16">
          ...
          <div class="flex flex-row items-center gap-8">
            <div class="flex flex-row items-center gap-2 px-4 py-1 font-semibold text-white rounded-lg bg-sky-500">
            ...
            <Link :href="route('admin.ballots.view', { ballot: petition?.ballot?.hash })" v-if="petition.ballot">
