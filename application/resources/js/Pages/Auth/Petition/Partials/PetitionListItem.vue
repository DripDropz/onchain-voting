          ...
          <div
            ...
            <div class="flex flex-row items-center gap-16">
                ...
                <div class="flex flex-row items-center gap-8">
                    <div class="flex flex-row items-center gap-2 bg-sky-500 text-white px-4 py-1 rounded-lg font-semibold">
                    ...
                    <div class="flex flex-row items-center gap-2 text-sky-500 border-2 border-sky-500 px-4 py-1 rounded-lg font-semibold">
            ...
            <div class="flex flex-row items-center gap-8">
              ...
              <div class="flex flex-row items-center gap-2">
                ...
                <span>{{ formatDate(petition.status === 'published' ? petition.started_at : petition.created_at) }}</span>
              </div>
            </div>
          </div>
        </div>
