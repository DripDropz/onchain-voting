                    ...
                    <transition enter-active-class="transition duration-100 ease-out"
                        ...
                        <MenuItems
                            ...
                            <MenuItem v-if ="ballot.status !== 'published'" v-slot="{ active }">
                                <a @click.prevent="publishBallot(ballot.hash)"
                                   :class="[active ? 'bg-gray-50 dark:bg-gray-900 cursor-pointer' : '', 'block px-3 py-1 text-sm leading-6 text-gray-900 dark:text-gray-300']">
