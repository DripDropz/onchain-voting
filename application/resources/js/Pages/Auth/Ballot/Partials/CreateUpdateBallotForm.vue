                ...
                <div
                    ...
                    <div class="flex items-center gap-8 px-2 py-4 xl:px-3">
                        ...
                        <input type="datetime-local" name="version" id="version" v-model="form.started_at"
                               ...
                               class="relative w-full flex flex-1 border-0 pt-2.5 sm:text-sm sm:leading-6 font-medium text-gray-900 dark:text-gray-100 placeholder:text-gray-400 bg-sky-100 dark:bg-gray-900 ring-1 ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-sky-600 dark:focus:ring-sky-700 rounded-lg"/>
                    </div>
                    <div class="flex items-center gap-8 px-2 py-4 xl:px-3">
                        <label for="version"
                        ...
                        <input type="datetime-local" name="version" id="version" v-model="form.ended_at"
                               placeholder="Datetime"
                               class="relative w-full flex flex-1 border-0 pt-2.5 sm:text-sm sm:leading-6 font-medium text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:ring-0 bg-sky-100 dark:bg-gray-900 ring-1 ring-gray-300 dark:ring-gray-700  focus:ring-sky-600 dark:focus:ring-sky-700 rounded-lg"/>
                    </div>
                        ...
                        <Listbox as="div" v-model="assigned" class="flex-shrink-0">
                            ...
                            <div class="relative">
                                ...
                                <transition leave-active-class="transition duration-100 ease-in"
                                    ...
                                    <ListboxOptions
                                        class="absolute right-0 z-10 py-3 mt-1 overflow-auto text-base bg-sky-100 rounded-lg shadow max-h-56 w-52 dark:bg-gray-900 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                        <ListboxOption as="template" v-for="assignee in assignees" :key="assignee.value"
                                                       :value="assignee" v-slot="{ active }">
                                            <li :class="[active ? 'bg-gray-100  dark:bg-gray-700' : 'bg-sky-100  dark:bg-gray-900', 'relative cursor-default select-none px-3 py-2']">
