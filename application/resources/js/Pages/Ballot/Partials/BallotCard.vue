    ...
    <section>
        <div class="relative">
            <div
                ...
                <header
                    class="block w-full resize-none border-0 text-gray-900 dark:text-gray-100 p-3 xl:p-4 dark:text-gray-100 sm:text-sm sm:leading-6 bg-white dark:bg-gray-900">
                ...
                <div class="flex items-center gap-8 px-2 py-4 xl:px-3">
                    ...
                    <p class="relative block w-full flex flex-1 border-0 p-2.5 sm:text-sm sm:leading-6 capitalize font-medium text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:ring-0 bg-white dark:bg-gray-900 rounded-lg">
                        {{ ballot.startedAt }}
                    </p>
                </div>
                ...
                <div class="flex items-center gap-8 px-2 py-4 xl:px-3">
                    <div class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300 w-44">Version</div>
                    <p class="relative block w-full flex flex-1 border-0 p-2.5 sm:text-sm sm:leading-6 font-medium text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:ring-0 bg-white dark:bg-gray-900 rounded-lg">
                        {{ ballot.version }}
                    </p>
                </div>
            ...
            <div class="absolute bottom-0 inset-x-px">
                <div
                    ...
                    <div class="flex-shrink-0">
                        <Link as="button"
                              :href="route( 'ballots.edit', { 'ballot': ballot?.hash})"
...
import BallotStatusBadge from "@/Pages/Ballot/Partials/BallotStatusBadge.vue";
