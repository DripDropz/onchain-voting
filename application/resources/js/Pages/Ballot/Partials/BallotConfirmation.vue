                ...
                <template v-if="!voteSaved || !voteRecordedOnChain || hasUnansweredQuestions">
                    <div>
                        ...
                        <div class="flex flex-col items-center justify-center gap-2 mt-8 ">
                            ...
                            <span >
                                {{ confirmationCount != 7 || !hasRegistration?'submit when all confirmations are done':'Confirmation succesfull, Submit!'}}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center gap-3 p-3 mt-auto">
                        ...
                        <button v-if="voteSaved && !voteRecordedOnChain && !hasUnansweredQuestions "
                            @click="emit('record-onchain')" type="button" :disabled="confirmationCount < 7 && !hasRegistration"
