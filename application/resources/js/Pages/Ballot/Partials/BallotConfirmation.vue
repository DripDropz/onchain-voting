                    ...
                    <div class="flex justify-center gap-3 p-3 mt-auto">
                        <div class="flex flex-col justify-center">
                            <button  v-if="!voteRecordedOnChain" @click="emit('change-choice')"
                                class="px-2 lg:px-3 py-1 text-xs xl:text-sm border border-white border-dashed rounded-lg hover:bg-sky-900/90">Change</button>
                        </div>
...
const voteSaved = computed(() => props.userResponse?.choices?.length > 0);
const voteRecordedOnChain = computed(() => false);
