                    ...
                    <div class="relative flex flex-1 mt-2">
                        ...
                        <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                            ...
                            <ListboxOptions
                                ...
                                <ListboxOption as="template" v-for="status in ballotStatuses" :key="status.case"
                                               :value="status.case" v-slot="{ active, selected }">
                ...
                <Listbox as="div" v-model="form.type"
                    ...
                    <div class="relative flex flex-1 mt-2">
                        ...
                        <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                            ...
                            <ListboxOptions
                                class="absolute z-10 w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 dark:bg-gray-700 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                <ListboxOption as="template" v-for="type in ballotTypes" :key="type.id" :value="type"
                    ...
                    <Listbox as="div" v-model="assigned" class="flex-shrink-0">
                        ...
                        <div class="relative">
                            ...
                            <transition leave-active-class="transition duration-100 ease-in"
                                ...
                                <ListboxOptions
                                    class="absolute right-0 z-10 py-3 mt-1 overflow-auto text-base bg-white rounded-lg shadow max-h-56 w-52 dark:bg-gray-900 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
