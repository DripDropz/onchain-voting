        ...
        <div class="flex flex-col gap-24">
            <div class="container flex flex-col justify-end h-screen pb-16 -mt-32">
                <div class="flex flex-row items-center justify-between">
                    <div>
                        <h1 class="-mt-16 text-4xl font-medium tracking-tight font-display text-slate-900 dark:text-slate-200 sm:text-6xl xl:text-7xl">
                        ...
                        <div
                            ...
                            <p>
                                Voting should be easy, secure, and accessible to everyone. With openchainvote,
                                you can vote on-chain with a simple transaction.
                            </p>
                        </div>
                    </div>
                    <div>
