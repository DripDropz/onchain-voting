<template>
    <button type="button" @click="configStore.toggleDarkMode()" aria-label="Toggle dark mode" class="px-3 py-2 transition bg-white rounded-full shadow-lg group shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20">
